  ...
  return (
    <>
      ...
      {/* <section className="bg-white p-8 m-4 rounded-lg shadow-md">
          <h2 className="text-xl font-bold text-blue-900">ユーザーの声</h2>
  ...
  return (
    <Container isColored>
      <div className={`flex flex-col gap-4 justify-center items-center max-w-screen-lg py-2 pb-10 px-3 w-full`}>
        <h2 className="text-3xl font-bold text-blue-900 text-center">Neuro Net とは</h2>
        ...
        {/* <ul className="pt-4 flex flex-col gap-10 sm:flex-row sm:mx-14 sm:gap-4">
          ...
          <li className="flex flex-col items-center relative">
            <h3 className="absolute top-[-14px] tracking-[1em] after:ml-[-1em] text-xl font-bold text-white bg-blue-600 w-52 text-center rounded-lg">解決策</h3>
...
const ConcernsSection: React.FC = () => {
  return (
    <Container>
      <div className={`flex flex-col gap-4 justify-center items-center max-w-screen-lg py-2 pb-10 px-3 w-full`}>
        <h2 className="text-3xl font-bold text-blue-900 text-center">既存SNSのお悩み</h2>
...
const ProcessSection: React.FC = () => {
  return (
    <Container isColored>
      <div className={`flex flex-col gap-4 justify-center items-center max-w-screen-lg py-2 pb-10 px-3 w-full`}>
        <h2 className="text-3xl font-bold text-blue-900 text-center">参加申請の流れ</h2>
        <ul className="pt-4 flex flex-col gap-10 sm:flex-row sm:mx-14 sm:gap-4">
          <li className="flex flex-col items-center relative sm:flex-1">
            <h3 className="absolute top-[-14px] tracking-[0.2em] after:ml-[-0.2em] text-xl font-bold text-white bg-blue-600 w-24 text-center rounded-lg">手順.1</h3>
            <div className="text-left bg-white rounded-lg text-xl p-3 pt-6 h-full w-full">
              アカウントを作成します
            </div>
          </li>
          <li className="flex flex-col items-center relative sm:flex-1">
            <h3 className="absolute top-[-14px] tracking-[0.2em] after:ml-[-0.2em] text-xl font-bold text-white bg-blue-600 w-24 text-center rounded-lg">手順.2</h3>
            <div className="text-left bg-white rounded-lg text-xl p-3 pt-6 h-full w-full">
              収入証明書（源泉徴収票等）をアップロード
            </div>
          </li>
          <li className="flex flex-col items-center relative sm:flex-1">
            <h3 className="absolute top-[-14px] tracking-[0.2em] after:ml-[-0.2em] text-xl font-bold text-white bg-blue-600 w-24 text-center rounded-lg">手順.3</h3>
            <div className="text-left bg-white rounded-lg text-xl p-3 pt-6 h-full w-full">
    ...
    <Container>
      <div className={`flex flex-col sm:flex-row-reverse max-w-screen-lg gap-2 mx-auto w-full`}>
        <div className="flex flex-col justify-center  min-w-[50%] py-4 box-border">
          ...
          <h3 className="text-3xl font-bold text-blue-900">話題をジャンルごとに選択可能</h3>
          <div className="pt-4">
      ...
      <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 mb-6 px-4 rounded">
        参加申請する
      </button>
    </Container>
  );
    ...
    <Container isColored>
      <div className={`flex flex-col sm:flex-row max-w-screen-lg gap-2 mx-auto w-full`}>
        <div className="flex flex-col justify-center  min-w-[50%] py-4 box-border">
          ...
          <h3 className="text-3xl font-bold text-blue-900">年収フィルタリング</h3>
          <div className="pt-4">
            年収800万円以上に限定することにより、
...
const Feature3Section: React.FC = () => {
  return (
    <Container>
      <div className={`flex flex-col sm:flex-row-reverse max-w-screen-lg gap-2 mx-auto w-full`}>
        <div className="flex flex-col justify-center  min-w-[50%] py-4 box-border">
          <h2 className="text-xl font-bold">特徴 3</h2>
          <h3 className="text-3xl font-bold text-blue-900">高度で知的な会話</h3>
          <div className="pt-4">
